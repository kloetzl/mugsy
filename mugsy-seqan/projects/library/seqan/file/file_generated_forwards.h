...
struct TagMultiFastaAlign_;       	// "projects/library/seqan/file/file_format_fasta_align.h"(48)
...
typedef Tag<TagMultiFastaAlign_> const MultiFastaAlign;       	// "projects/library/seqan/file/file_format_fasta_align.h"(49)
...
template <typename TFile, typename TSize> void _fasta_align_scan_line(TFile & file, TSize & count);       	// "projects/library/seqan/file/file_format_fasta_align.h"(55)
...
template <typename TFile, typename TStringContainer, typename TSource, typename TSpec> void _write_impl(TFile& file, Align<TSource, TSpec>& align, TStringContainer& ids, FastaAlign);       	// "projects/library/seqan/file/file_format_fasta_align.h"(250)
...
template <typename TFile> void goNext(TFile & file, FastaAlign);       	// "projects/library/seqan/file/file_format_fasta_align.h"(237)
...
template <typename TFile, typename TSource, typename TSpec> void read(TFile & file, Align<TSource, TSpec> & align, FastaAlign);       	// "projects/library/seqan/file/file_format_fasta_align.h"(76)
...
template <typename TFile, typename TStringContainer> void readIDs(TFile& file, TStringContainer& ids, FastaAlign);       	// "projects/library/seqan/file/file_format_fasta_align.h"(182)
...
template <typename TFile, typename TMeta> void readMeta(TFile & file, TMeta & meta, FastaAlign);       	// "projects/library/seqan/file/file_format_fasta_align.h"(227)
...
template <typename TFile, typename TSource, typename TSpec> void write(TFile & file, Align<TSource, TSpec>& align, FastaAlign);       	// "projects/library/seqan/file/file_format_fasta_align.h"(288)
template <typename TFile, typename TStringContainer, typename TSource, typename TSpec> void write(TFile & file, Align<TSource, TSpec> & align, TStringContainer& ids, FastaAlign);       	// "projects/library/seqan/file/file_format_fasta_align.h"(296)
template <typename TFile, typename TStringContainer, typename TSource, typename TSpec> void write(TFile & file, Align<TSource, TSpec>* align, TStringContainer & ids, FastaAlign);       	// "projects/library/seqan/file/file_format_fasta_align.h"(304)
template <typename TFile, typename TStringContainer, typename TSource, typename TSpec, typename TMeta> void write(TFile & file, Align<TSource, TSpec> & align, TStringContainer& ids, TMeta &, FastaAlign);       	// "projects/library/seqan/file/file_format_fasta_align.h"(312)

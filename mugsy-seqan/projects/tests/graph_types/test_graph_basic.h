...
void Test_GraphBasics() {
	...
	debug::verifyCheckpoints("projects/library/seqan/graph_types/graph_base.h");
	debug::verifyCheckpoints("projects/library/seqan/graph_types/graph_idmanager.h");
	debug::verifyCheckpoints("projects/library/seqan/graph_types/graph_edgestump.h");
}
